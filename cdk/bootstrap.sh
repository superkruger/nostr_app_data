...
npx cdk bootstrap aws://418272791745/us-east-2 --profile AdminUserNostr --cloudformation-execution-policies arn:aws:iam::aws:policy/AdministratorAccess --context environment=$1
